...
exports.tagInfo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, getTagInfo, _a, name_tag, img_tag, description, tagsFollowers;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                getTagInfo = _b.sent();
                _a = getTagInfo.data, name_tag = _a.name_tag, img_tag = _a.img_tag, description = _a.description, tagsFollowers = _a.tagsFollowers;
                res.status(200).json({
